...
#### 芯片的 iROM（内部只读存储器）代码不完成系统时钟和内存初始化的主要原因如下：
...
![76594326194](C:\Users\魏士雄\AppData\Local\Temp\1765943261949.png)

![76594329952](C:\Users\魏士雄\AppData\Local\Temp\1765943299525.png)

![76594334012](C:\Users\魏士雄\AppData\Local\Temp\1765943340125.png)

![76597191049](C:\Users\魏士雄\AppData\Local\Temp\1765971910494.png)

![76597201992](C:\Users\魏士雄\AppData\Local\Temp\1765972019923.png)

![76597210550](C:\Users\魏士雄\AppData\Local\Temp\1765972105500.png)

### Linux 内核目录核心结构

| 目录 / 文件   | 作用说明                                                     |
| ------------- | ------------------------------------------------------------ |
| arch 目录     | 存放硬件架构（如 arm）相关代码：- `arch/arm/boot/compressed`：内核自解压代码（压缩内核启动时自动解压）；- `arch/arm/kernel/head.S`：Linux 内核的启动入口代码；- `arch/arm/boot/dts`：设备树源文件（存储开发板硬件信息，替代传统硬编码）；- `arch/arm/configs`：SOC 对应的内核配置文件（预定义硬件的编译选项） |
...
![76597163728](C:\Users\魏士雄\AppData\Local\Temp\1765971637282.png)

![76597242343](C:\Users\魏士雄\AppData\Local\Temp\1765972423435.png)
...
tristate --> <> 三态
	...
	<*>  --> 对应的驱动被编译到uImage中
	< >  --> 对应的驱动不被编译
	<M>  --> 对应的驱动采用模块化的方式进行编译，使用make modules命令编译模块化的驱动程序
#### busybox
...
![76604680875](C:\Users\魏士雄\AppData\Local\Temp\1766046808756.png)![76604690409](C:\Users\魏士雄\AppData\Local\Temp\1766046904090.png)
